...
COMMENT ON COLUMN adj_rib_in.valid_from IS 'Timestamp the entry became valid.';
COMMENT ON COLUMN adj_rib_in.valid_to IS 'Timestamp the entry was invalidated.';
...
CREATE INDEX bmp_src__neighbor_addr__prefix ON adj_rib_in (bmp_src, neighbor_addr, prefix);
